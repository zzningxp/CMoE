...
@torch.no_grad()
def construct_moe(model, moe_model_flag, if_quant_layer, if_quant_attn, layer, layer_idx, inp, attention_mask, position_ids, position_embeddings, 
...
def reconstruct_sequential(model, tokenizer, dataloader, args):
    print('Starting ...')

...
python run_cmoe.py ~/models/deepseek-moe-16b-base/ wikitext2 --new-eval --nshared 0 --nactivated 8  --nexperts 64  --nsamples 16 --extra-lr 0.001 --bias-speed 0.001 --sft-bsz 1 --carve-bsz 1 --epoch 0
